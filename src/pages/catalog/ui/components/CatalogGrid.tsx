...
// Весь каталог помещается на одну страницу — так и отдаём. У страниц 2 и 3 canonical вёл на
// первую, и их товары оставались без учитываемой ссылки; а карточки сверх пятой прятались на
// узких экранах через CSS, и с телефона половина каталога была недостижима вовсе. Пагинация
// не удалена: когда инструментов станет больше, она включится снова.
