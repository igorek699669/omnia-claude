...
export function OfertaPage() {
  return (
    <section className="mx-auto max-w-[900px] px-5 py-16 md:px-12">
      ...
      <p className="mt-4 text-sm text-ink-600">Действует в редакции от 19.08.2026.</p>
      ...
      <div className="mt-10 flex flex-col gap-10 text-[17px] leading-relaxed">
        ...
        <LegalBlock title="2. Цена товара">
          <p>
            Цена товара указывается в карточке товара на сайте в рублях РФ и включает НДС,
            если применимо. Продавец вправе изменить цену до момента оформления заказа
        ...
        <LegalBlock title="4. Порядок оплаты и доставки">
          <p>
            Оплата — банковской картой онлайн через ЮKassa. Доставка осуществляется
