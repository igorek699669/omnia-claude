    ...
    <section className="mx-auto max-w-[900px] px-5 py-16 md:px-12">
      ...
      <div className="mt-10 flex flex-col gap-10 text-[17px] leading-relaxed">
        <Block title="Как мы отправляем">
          Каждый инструмент едет в защитном тканевом чехле внутри
          плотного короба с пенопластовым ложементом. Отправляем СДЭК — до пункта выдачи
          или курьером, на ваш выбор.
        </Block>
        ...
        <Block title="Оплата">
          ...
          Telegram/WhatsApp/Max, если удобнее обсудить детали перед покупкой.
        </Block>
        <Block title="Переход рисков">
          Право собственности и риск случайной утраты или повреждения инструмента переходят
          к вам в момент получения заказа — из рук курьера или при выдаче в пункте СДЭК.
        </Block>
        <Block title="Если что-то пошло не так">
          Мы отвечаем за сохранность инструмента до момента получения. При повреждении
          в доставке — фиксируйте на видео при вскрытии и напишите нам любым удобным способом.
        </Block>
      </div>
    </section>
  );
