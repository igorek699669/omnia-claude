...
const faq = [
  ...
  [
    ...
    "Да. У каждого инструмента в каталоге есть запись его реального строя — это не общий семпл, а звук именно того ханга, который вы получите. Если хотите послушать подробнее или сравнить несколько строёв, напишите нам в Telegram, WhatsApp или MAX — пришлём дополнительную запись.",
  ],
  [
  ...
  [
    ...
    "Мы работаем с нержавеющей сталью Ember: она не ржавеет, дольше держит строй и даёт длинное послезвучие с богатыми обертонами. Встречается ещё нитрированная сталь: она дешевле и звучит суше, но требует регулярной смазки, иначе появляется ржавчина.",
  ],
] as const;
