...
const left = [
  ...
  ["В 3 раза дольше звучание", "По сравнению с другими видами стали"],
] as const;

const right = [
  ["Яркий, запоминающийся звук", "Насыщенные обертоны, мягкие переходы и звучные перкуссионные щелчки"],
  ["Не расстраивается при активной игре", "Сталь с добавлением титана препятствует быстрой потере строя"],
] as const;
