...
const points = [
  ["Отвечаем за сохранность и качество", "Принимаем ответственность за инструмент до момента получения и проверки ( качество настройки и состояние инструмента )."],
  ["Индивидуальные заказы без переплаты", "Соберём инструмент под ваш строй и звукоряд без наценки за индивидуальность."],
  ["Цены без лишних посредников", "Вы не оплачиваете цепочку комиссий — это выгоднее и для вас, и для нас."],
  ["Делаем для людей", "Каждый инструмент проходит ручную настройку и отслушивается мастером."],
] as const;
