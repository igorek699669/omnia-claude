...
/**
 * Подтверждение телефона прямо на чекауте — тем же входящим звонком, что и на /auth. Оно не
 * только помечает номер проверенным, но и заводит сессию: гость, оформивший заказ, заодно
