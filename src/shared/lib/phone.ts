/**
 * Телефон в проекте живёт в двух видах: маска «+7 (900) 000-00-00» в полях ввода
 * (PhoneInput) и E.164 «+79000000000» во всём, что уходит наружу — Better Auth,
 * SMS.ru, СДЭК. Единственный конвертер между ними, чтобы не плодить по месту.
 */
