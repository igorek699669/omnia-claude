export const CONTACT_PHONE = "+7 903 819-04-16";
export const CONTACT_PHONE_HREF = "tel:+79038190416";
export const CONTACT_EMAIL = "omniaworkshop@yandex.ru";
export const CONTACT_EMAIL_HREF = "mailto:omniaworkshop@yandex.ru";
