...
/**
 * Каждый ханг едет в собственном коробе с пенопластовым ложементом (см. копирайт src/pages/delivery) —
 * фиксированные реальные вес и габариты упакованного инструмента, одна коробка на единицу товара.
 *
