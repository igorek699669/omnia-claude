/**
 * Крупный заголовок секции. По умолчанию h2 — на большинстве страниц это подзаголовок
 * внутри уже существующей иерархии. `as="h1"` ставится там, где это главный заголовок
