...
/**
 * Горизонтальный слайдер на Embla — конечный, с точками и стрелками. Управление скрывается
 * само, когда все слайды помещаются в экран: на широком брейкпоинте блок выглядит обычным
 * рядом карточек, на узком листается. Ширину слайда задаёт вызывающий.
 */
