...
/**
 * Навигационная цепочка «Главная → Каталог → Ханг D Kurd 11». Видимые ссылки и разметка
 * BreadcrumbList одним компонентом: поисковик берёт цепочку из разметки, а покупателю нужен
 * путь обратно в каталог — до этого с карточки не вело ни одной ссылки на другой раздел.
 */
