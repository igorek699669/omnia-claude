...
/**
 * dx/dy — смещение от главной кнопки при раскрытии, дугой слева-сверху. Радиус 120 при шаге
 * 30° разводит центры на ~62px — больше диаметра кнопки (50px), иначе кружки наезжают.
 */
