...
export function Header() {
  ...
  async function handleSignOut() {
    ...
    // Без этого уже отрисованные серверные страницы сессию не перепроверяют: нажавший
    // «Выйти» на /profile так и видел бы свои заказы, пока не перейдёт куда-то сам.
    router.refresh();
  }
