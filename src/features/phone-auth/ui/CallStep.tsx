 ...
 * звонок сбрасывается, опрос в useCallCheck ловит подтверждение. Кнопка «Позвонить» — ссылка
 * tel: для мобильного; на десктопе номер набирают руками, поэтому он показан текстом рядом.
 */
