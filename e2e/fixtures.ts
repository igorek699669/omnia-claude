...
export class Storefront {
  ...
  /**
   * Из корзины на чекаут — именно кликом: ссылка кладёт выбранные позиции в
   * sessionStorage (CHECKOUT_SELECTION_KEY), и без этого клика чекаут возьмёт не тот состав.
   */
